...
Please complete the setup instructions **before** the first day of the workshop.

## Create Your Workspace

During the workshop, you will use a coding agent running on a virtual machine,
called a [Coder Workspace](https://coder.dreamlab.ucsb.edu). It can take a few
minutes to create your workspace so we recommend doing it before the workshop.
To create your workspace:

1. Log in to the [Coder Workspaces](https://coder.dreamlab.ucsb.edu) environment using your UCSB NetID.
...
**This is optional**. If you prefer to use the VS Code desktop app, rather than
the browser-based version, use these instructions to set things up.
