...
sensitive data with third parties (model providers may be use your data to train
...
![Using LLMs to answer questions directly](../diagrams/question_answer.svg)

![Using LLMs to generate code to answer questions](../diagrams/question_code_answer.svg)
...
![Coding agents mediate interaction between the user, the LLM, and coding tools](../diagrams/agent.svg){width=50%}
