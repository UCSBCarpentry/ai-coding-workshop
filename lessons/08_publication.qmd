...
Before moving to the publication phase, you should review the dashboard and verify that is working correctly. Most of the time, the agent can check that the dashboard is running, but that doesn't mean it's working correctly. To visualy inspect the dashboard, open a new terminal window and run the following command to start the Shiny server:
...
Just for reference, this is what the final dashboard looks in our case:
