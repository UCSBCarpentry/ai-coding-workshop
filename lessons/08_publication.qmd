...
Before moving to the publication phase, you should review the dashboard and verify that it is working correctly. Most of the time, the agent can check that the dashboard is running, but that doesn't mean it's working as expected. To visually inspect the dashboard, open a new terminal window and run the following commands to start the Shiny server:
