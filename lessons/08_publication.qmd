...
```html
https://github.com/jairomelo/NOAA-water-temp-CA
```

You can read the README file to understand the data and its structure, as well as the code used to download the data from NOAA.
