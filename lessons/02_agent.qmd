...
![Selecting the DREAM Lab AI Gateway provider](../images/opencode_connect_provider.png)

**2. Enter your API key.** Paste the API key you were given for the workshop and
press <kbd>Enter</kbd> to submit.

![Entering your API key](../images/opencode_connect_apikey.png)
...
![Selecting the Gemini 3.5 Flash model](../images/opencode_connect_model.png)
