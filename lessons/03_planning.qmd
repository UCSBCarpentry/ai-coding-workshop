...
:::{.callout-warning}
After toggling between modes, always check which model your are using as Plan and Build modes can use different model.
:::
...
![Plan mode example - Frist prompt answer](../images/03-plan_mode-prompt1.png){fig-alt="Plan mode prompt answer showing the various proposed steps and supplemtal infomration requests" width=110%}
...
#### ...and repeat until you are satisfy!
...
Making sure in you are in Plan mode:
