...
::: {.callout-note}
Opencode can assist you with these various steps. However, for management and security reasons, it is recommended to launch opencode from a project-specific directory, as it requires by default explicit permission to access any files outside of that directory.
:::
