...
- **AGENTS.md:** You can create an `AGENTS.md` file to guide your agent's behavior. You can use [`_AGENTS.md`](_AGENTS.md) as a starting point. Rename the file to `AGENTS.md` and add your own instructions for your agent.
