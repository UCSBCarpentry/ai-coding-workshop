...
A common GIS task is to download some data and output maps to make sure the data is relevant to a task at hand. Using Rstudio or Positron, this could take many lines of code as preliminary individual visualizations are made, ranges of datavalues explored, metadata examined. 
