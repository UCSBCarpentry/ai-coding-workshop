...
1.  Download a Digital Elevation Model (DEM) Covering our area
...
- Use Python or R to implement this workflow. When using R, favor recent geospatial packages such as `sf` and `terra` and the tidyverse style guide
